				...
				<center>
					<div class="box">
						<form name="frmConsultar" method="POST">
							...
							<td>
								<div>
									<input type="submit" name="Guardar" value="Guardar" class="guardar" onclick="window.document.frmConsultar.action = 'guardarNU.php'" disabled>
							</div>
							</td>
							<td>
								<div>
									<input type="submit" name="Consultar" value="Consultar" class="consultar" onclick="window.document.frmConsultar.action = 'consultar_usuario.php'">
								</div>
							</td>
							<td>
								<div>
									<input type="submit" name="Modificar" value="Modificar" class="modificar" onclick="window.document.frmConsultar.action = 'modificar_usuario.php'">
								</div>
							</td>
							<td>
								<div>
									<input type="submit" name="Eliminar" value="Eliminar" class="eliminar" onclick="window.document.frmConsultar.action = 'eliminar_U.php'">
								</div>
							</td>
							<td>
								<div>
