<?php
	...
	if($_POST['Eliminar']){
		if(isset($_SESSION['usuario'])){
			...
			$cnx = conectar();
			$sql = "DELETE FROM Asistencia WHERE AsistenciaId='". $_POST['asistenciaid']."'";
		...
		echo"<script type='text/javascript'>window.close();window.open('modificar_asistencia.php')</script>";
	}
?>
