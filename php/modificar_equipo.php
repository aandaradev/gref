...
?>
		...
		<html>
			...
			<body>
				...
				<strong>
					Modificar Infomaci&oacute;n de Equipos
				</strong>
			</p>
				<header>
				<center>
						...
						<form name="frmModificar" method="POST">
								...
								<?
									while(list($codigo,$descripcion,$cantidad,$estado) = mysql_fetch_array($consulta)){
										echo"<tr>";
											...
											echo"<td><div><input type='text' name='codigo' value='$codigo'></div></td>";
										echo"</tr>";
										echo"<tr>";
										echo"<td><div><strong>Descripci&oacute;n:</strong></div></td>";
											echo"<td><div><textarea name='descripcion'>$descripcion</textarea></div></td>";
										echo"</tr>";
										echo"<tr>";
											echo"<td><div><strong>Cantidad:</strong></div></td>";
											echo"<td><div><input type='text' name='cantidad' value='$cantidad'></div></td>";
										echo"</tr>";
										echo"<tr>";
											echo"<td><div><strong>Estado:</strong></div></td>";
											echo"<td><div><input type='text' name='estado' value='$estado'></div></td>";
										echo"</tr>";
							...
							<table border="0" cellpadding="2px" cellspacing="2px" align="center">
								<tr>
									...
									<td>
										<div>
											<input type="submit" name="Guardar" value="Guardar" class="guardar" onclick="window.document.frmModificar.action = 'guardar_NE.php'" disabled>
									</div>
									</td>
									<td>
										<div>
											<input type="submit" name="Consultar" value="Consultar" class="consultar" onclick="window.document.frmModificar.action = 'consultar_equipo.php'">
										</div>
									</td>
									<td>
										<div>
											<input type="submit" name="Modificar" value="Modificar" class="modificar" onclick="window.document.frmModificar.action = 'modificar_E.php'">
										</div>
									</td>
									<td>
										<div>
											<input type="submit" name="Eliminar" value="Eliminar" class="eliminar" onclick="window.document.frmModificar.action = 'eliminar_E.php'">
										</div>
									</td>
									<td>
										<div>
