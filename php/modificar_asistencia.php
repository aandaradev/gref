		...
		<html>
			...
			<body>
				<?php
					...
					$cnx = conectar();
					$sql = "SELECT Asistencia.AsistenciaId,Asistencia.CodGref,personal.CedId,personal.Apellidos,personal.Nombres,Asistencia.FechaA FROM Asistencia, personal WHERE Asistencia.CodGref = personal.Codgref and Asistencia.AsistenciaId='". $_POST['asistenciaid']."' and personal.CodGref='". $_POST['codigo']."'";
				...
				<strong>
					Modificar Infomaci&oacute;n de Asistencia
				</strong>
			</p>
				<header>
				<center>
						...
						<form name="frmConsultar" method="POST">
							<table border="0" cellspadding="2px" cellspacing="2px" align="center">
								<?php
									while(list($asistenciaid,$codigo,$ci,$apellidos,$nombres,$fechaA) = mysql_fetch_array($consulta)){
										echo"<tr>";
											...
											echo"<td><div><input type='text' name='asistenciaid' value='$asistenciaid' disabled></div><div><input type='hidden' name='asistenciaid' value='$asistenciaid'></div></td>";
										echo"</tr>";
										echo"<tr>";
									echo"<td><div><strong>C&oacute;digoGref:</strong></div></td>";
									echo"<td><div><input type='text' name='codigo' value='$codigo'></div><div><input type='hidden' name='codigo' value='$codigo'></div></td>";
								echo"</tr>";
								echo"<tr>";
								...
								echo"<tr>";
									...
									echo"<td><div><input type='text' name='fechaA' value='$fechaA'></div></td>";
								echo"</tr>";
							...
							<td>
								<div>
									<input type="submit" name="Modificar" value="Modificar" class="modificar" onclick="window.document.frmConsultar.action = 'modificar_A.php'">
								</div>
							</td>
							<td>
								<div>
